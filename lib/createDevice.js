        ...
        switch (device.model) {
            case 'gateway':
                newDevice = {
                    ...
                    types: [
                        ...
                        { identifier: 'color', type: 'color', unit: '', min: 0, max: 16777216, sensor: false },
                        ...
                        { identifier: 'illumination', type: 'illumination', unit: 'lux', min: 0, max: 9999, sensor: true }
                    ]
                };
                break;
            case 'switch':
            ...
            case 'cube':
                ...
                newDevice = {
                    ...
                    types: [
                        { identifier: 'charge', type: 'charge', unit: '%', min: 0, max: 100, sensor: true },
                        { identifier: 'magnet', type: 'status', min: 0, max: 1, sensor: true },
                    ]
                };
                break
            default:
