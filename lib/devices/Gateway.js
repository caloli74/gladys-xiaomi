    ...
    deviceMessage(message) {
        ...
        if (message.data){
            ...
            if(data.rgb){
                ...
                buffer.writeUInt32BE(state.rgb, 0)
                this.color.r = buffer.readUInt8(1)
                this.color.g = buffer.readUInt8(2)
                this.color.b = buffer.readUInt8(3)
                this.intensity = buffer.readUInt8(0)
            }
        }
        return ({ msg: 'info', data: this });
    }
    /*
        playSound(sound) {
