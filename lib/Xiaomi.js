...
module.exports = class Xiaomi extends events.EventEmitter {
    ...
    onMessage(msg) {
        ...
        //console.log('xioami ' + (new Date).toLocaleTimeString() + ' : ' + message.cmd + ' ' + message.model + ' ' + JSON.stringify(this.devices));
        ...
        answer = this.devices[message.sid].deviceMessage(message);
        if (answer)
        {
            this.emit(msg,data);
        }
